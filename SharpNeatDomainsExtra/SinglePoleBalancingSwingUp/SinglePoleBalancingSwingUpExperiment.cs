...
namespace SharpNeat.DomainsExtra.SinglePoleBalancingSwingUp
{
    ...
    /// </summary>
    public class SinglePoleBalancingSwingUpExperiment : IGuiNeatExperiment
    {
        ...
        /// Default constructor.
        /// </summary>
        public SinglePoleBalancingSwingUpExperiment()
        {
        }
        ...
        public NeatEvolutionAlgorithm<NeatGenome> CreateEvolutionAlgorithm(IGenomeFactory<NeatGenome> genomeFactory, List<NeatGenome> genomeList)
        {
            ...
            SinglePoleBalancingSwingUpEvaluator evaluator = new SinglePoleBalancingSwingUpEvaluator();
        ...
        /// </summary>
        public AbstractView CreateGenomeView()
        {
        ...
        /// </summary>
        public AbstractView CreateDomainView()
        {
            return new SinglePoleBalancingSwingUpView(CreateGenomeDecoder());
        }
