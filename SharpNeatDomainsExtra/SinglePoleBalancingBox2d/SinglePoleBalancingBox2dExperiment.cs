...
namespace SharpNeat.DomainsExtra.SinglePoleBalancingBox2d
{
    ...
    /// </summary>
    public class SinglePoleBalancingBox2dExperiment : IGuiNeatExperiment
    {
        ...
        /// Default constructor.
        /// </summary>
        public SinglePoleBalancingBox2dExperiment()
        {
        }
        ...
        {
            return new SinglePoleBalancingBox2dView(CreateGenomeDecoder());
        }
