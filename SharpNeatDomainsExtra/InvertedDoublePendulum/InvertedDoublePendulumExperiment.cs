...
namespace SharpNeat.DomainsExtra.InvertedDoublePendulum
{
    ...
    /// </summary>
    public class InvertedDoublePendulumExperiment : IGuiNeatExperiment
    {
        ...
        /// Default constructor.
        /// </summary>
        public InvertedDoublePendulumExperiment()
        {
        }
        ...
        {
            return new InvertedDoublePendulumView(CreateGenomeDecoder());
        }
