...
namespace SharpNeatGUI
{
    ...
    {
        private IAlgorithmDriver _ea;
        private TimeSeriesDataSource[] _dataSourceArray;
        private RollingPointPairList[] _pointPlotArray;
        ...
        public TimeSeriesGraphForm(string title, string xAxisTitle, string y1AxisTitle, string y2AxisTitle,
            TimeSeriesDataSource[] dataSourceArray, IAlgorithmDriver ea)
        {
            InitializeComponent();

            this.FormClosing += HandleClose;
        ...
        /// </summary>
        public void Reconnect(IAlgorithmDriver ea)
        {
            // Clean up.
            if (null != _ea)
            {
        ...
        private void InitGraph(string title, string xAxisTitle, string y1AxisTitle, string y2AxisTitle,
