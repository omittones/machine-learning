...
namespace SharpNeat.Domains
{
    ...
    /// </summary>
    public partial class CppnGenomeView : AbstractView
    {
        private readonly NetworkGraphFactory _graphFactory = new NetworkGraphFactory();
        private readonly IOGraphViewportPainter _viewportPainter;
        ...
        public override void RefreshView(object genome)
        {
            ...
            var graph = _graphFactory.CreateGraph(neatGenome);
