...
namespace SharpNeat.Domains
{
    ...
    /// </summary>
    public interface IExperiment<TGenome> where
        TGenome : class, IGenome<TGenome>
    {
        /// <summary>
        ...
        /// </summary>
        List<TGenome> LoadPopulation(XmlReader xr);

        /// <summary>
        /// Save a population of genomes to an XmlWriter.
        /// </summary>
        void SavePopulation(XmlWriter xw, IList<TGenome> genomeList);

        /// <summary>
        /// Create a genome decoder for the experiment.
        /// </summary>
        IGenomeDecoder<TGenome, IBlackBox> CreateGenomeDecoder();

        /// <summary>
        /// Create a genome factory for the experiment.
        /// </summary>
        IGenomeFactory<TGenome> CreateGenomeFactory();
        ...
        /// </summary>
        NeatEvolutionAlgorithm<TGenome> CreateEvolutionAlgorithm();
        ...
        /// </summary>
        NeatEvolutionAlgorithm<TGenome> CreateEvolutionAlgorithm(int populationSize);
        ...
        /// </summary>
        NeatEvolutionAlgorithm<TGenome> CreateEvolutionAlgorithm(IGenomeFactory<TGenome> genomeFactory, List<TGenome> genomeList);
    }
}
